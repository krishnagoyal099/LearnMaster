  ...
  return (
    <div className="min-h-screen gradient-bg">
      ...
      <div className="flex min-h-[calc(100vh-4rem)]">
        ...
        <div className="w-80 border-r border-border bg-background/50 dark:border-white/10 dark:bg-white/5 backdrop-blur-sm">
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  className="h-8 px-3 text-muted-foreground hover:text-foreground hover:bg-accent rounded-md"
                >
                  New Chat
                </Button>
                ...
                <div className="space-y-2">
                  {chatSessions.map((session) => (
                    <div
                      ...
                      className={`group relative flex items-start gap-3 p-3 rounded-lg hover:bg-accent cursor-pointer transition-all duration-200 ${
                        session.id === sessionId ? 'bg-accent' : ''
                      }`}
                    >
                      <div className="flex-1 min-w-0">
                        <p className="text-sm text-foreground font-medium line-clamp-2 leading-tight mb-1">
                          {session.title}
                        </p>
                        {session.lastMessage && (
                      ...
                      <Button
                        ...
                        className="h-6 w-6 p-0 opacity-0 group-hover:opacity-100 text-muted-foreground hover:text-foreground hover:bg-accent rounded transition-all"
                      >
        ...
        <div className="flex-1 flex flex-col">
          ...
          {/* Chat Input */}
          <div className="p-4 border-t border-border bg-background/50 dark:border-white/10 dark:bg-white/5 backdrop-blur-sm">
            <div className="max-w-4xl mx-auto flex gap-4">
              <div className="flex-1 relative">
                <Textarea
                  ...
                  className="min-h-[44px] max-h-32 pr-12 bg-background border-border text-foreground placeholder:text-muted-foreground focus:border-ring resize-none dark:bg-white/10 dark:border-white/20 dark:text-white dark:placeholder:text-white/50 dark:focus:border-white/40"
                />
                {charCount > 0 && (
